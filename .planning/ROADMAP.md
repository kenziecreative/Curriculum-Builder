...
- [ ] **Phase 17: Vocabulary & Plain Language** - Remove all remaining ID jargon from every command and output visible to users
...
| 17. Vocabulary & Plain Language | v4.0 | 0/3 | Not started | - |
