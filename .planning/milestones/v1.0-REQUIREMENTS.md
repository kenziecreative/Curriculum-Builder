# Requirements Archive: v1.0 KNZ Curriculum Builder MVP
...
- **INTK-11**: Audit mode produces a curriculum gap report alongside the standard `project-brief.md` — identifying what the existing materials have, what's shallow, and what's missing relative to the full pipeline schema (missing transfer connections, implicit social learning, absent reflection prompts, orphaned outcomes, etc.)
...
*These require real programs running through the system first — usage data is a prerequisite.*
